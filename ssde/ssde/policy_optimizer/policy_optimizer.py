...
from ssde.policy.policy import Policy
from ssde.utils import make_batch_ph
...
def make_policy_optimizer(sess, policy, policy_optimizer_type, **config_policy_optimizer):
    ...
    if policy_optimizer_type == "pg":
        from ssde.policy_optimizer.pg_policy_optimizer import PGPolicyOptimizer
        ...
        from ssde.policy_optimizer.ppo_policy_optimizer import PPOPolicyOptimizer
        ...
        assert issubclass(policy_optimizer_class, Policy), \
                "Custom policy {} must subclass ssde.policy.Policy.".format(policy_optimizer_class)
