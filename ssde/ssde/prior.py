...
from ssde.library import TokenNotFoundError, MultiDiscreteAction
from ssde.subroutines import ancestors
from ssde.subroutines import jit_check_constraint_violation, \
...
from ssde.language_model import LanguageModelPrior as LM
...
class Constraint(Prior):
    ...
    def is_violated(self, actions, parent, sibling):
        ...
        does not have to write a function twice for both ssde and Deap. 
