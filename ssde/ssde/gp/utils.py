...
from ssde.program import _finish_tokens
...
def multi_mutate_dgsr(individual, expr, pset):
    """Randomly select one of four types of mutation."""
...
def create_primitive_set(lib):
    """Create a DEAP primitive set from a ssde.libraryLibrary."""
...
def individual_to_ssde_aps(individual, library):
