...
mutation_ops_dict = {
    "multi_mutate" : U.multi_mutate_dgsr,
...
class GPController:
    ...
    def __call__(self, actions):
        ...
        # TODO: Decide whether to select initial population from ssde batch randomly or via
        ...
        # Get ssde generated batch members into Deap based "individuals"
        
            
        individuals = [
            self.creator.Individual(a, self.pset,
                                                       self.max_mutations,
