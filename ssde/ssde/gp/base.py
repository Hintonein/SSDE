...
from ssde.program import from_tokens, _finish_tokens, Program
...
class RunOneStepAlgorithm:
    ...
    def __init__(self, toolbox, cxpb, mutpb, verbose=__debug__):
        """
        Initialize the GP algorithm that will run each step of evolution. 
        This includes crossover, mutation and hall of fame logging. 
    ...
    def _eval(self, population):
        ...
        ----------
        population: list
            This is a list of deap individuals defined as a gp.PrimitiveTree 
            with fitness=creator.FitnessMin.
        """
    ...
    def _var_and(self, population):
        """
        Apply crossover AND mutation to each individual in a ppopulation given a constant probability.
    ...
    def __call__(self, hof=None, iter=None):
        """
        Called from the GP controller. This wraps selection, mutation, crossover and
        hall of fame compuatation over all the individuals in the population for this
        epoch/step.
