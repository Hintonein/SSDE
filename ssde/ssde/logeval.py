...
class LogEval():
    ...
    def _get_log(self, log_type):
        ...
        r = re.compile(r"ssde_{}_\d+_{}.csv".format(task_name, log_type))
    ...
    def plot_results(self, results, log_type, boxplot_on=False, show_plots=False, save_plots=False):
        ...
        plt.tight_layout()
        if save_plots:
            save_path = os.path.join(self.save_path, "ssde_{}_plot_{}.png".format(self.config["experiment"]["task_name"], log_type))
