...
from ssde.task import set_task
from ssde.train import Trainer
from ssde.checkpoint import Checkpoint
from ssde.train_stats import StatsLogger
from ssde.prior import make_prior
from ssde.program import Program
from ssde.config import load_config
from ssde.tf_state_manager import make_state_manager

from ssde.policy.policy import make_policy
from ssde.policy_optimizer import make_policy_optimizer
...
class DeepSymbolicOptimizer():
    ...
    def make_gp_controller(self):
        if self.config_gp_meld.pop("run_gp_meld", False):
            from ssde.gp.gp_controller import GPController
    ...
    def make_output_file(self):
        ...
        output_file = os.path.join(save_path,
                                   "ssde_{}_{}.csv".format(task_name, seed))
